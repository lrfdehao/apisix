...
local function check_content_length(ctx, body_buffer_size, content_length)
    if not content_length then
        return
    end

    if body_buffer_size > content_length then
...
--  ...
function _M.hold_body_chunk(ctx, hold_the_copy, content_length)
    ...
    if type(chunk) == "string" and chunk ~= "" then
        ...
        check_content_length(ctx, body_buffer_size, content_length)
    end
